...
ray exec ../autoscale.yaml "python /home/ubuntu/adversarial_sim2real/run_scripts/linear_env/run_linear_env.py \
--num_iters 300 --train_batch_size 30000 --num_cpus 8 --advs_per_strength 0 \
--num_adv_strengths 0 --advs_per_rew 0 --num_adv_rews 0 --exp_title linear_dr_d10_h200_smallbatch --run_transfer_tests \
--grid_search --use_s3 --dim 10 --multi_node --horizon 200 --scaling -0.8 --adv_strength 0.4 --agent_strength 1.1 \
--eigval_rand --regret" \
--start --stop --tmux --cluster-name=ev_lin_test1
...
ray exec ../autoscale.yaml "python /home/ubuntu/adversarial_sim2real/run_scripts/linear_env/run_linear_env.py \
--num_iters 300 --train_batch_size 30000 --num_cpus 8 --advs_per_strength 1 \
--num_adv_strengths 1 --advs_per_rew 1 --num_adv_rews 1 --exp_title linear_RARL_d10_conc100_h200_smallbatch --run_transfer_tests \
--grid_search --use_s3 --dim 10 --multi_node --horizon 200 --scaling -0.8 --adv_strength 0.4 --agent_strength 1.1 --regret --adv_action_type eigs" \
--start --stop --tmux --cluster-name=ev_lin_test2

# 3d experiments w/ 5 RARL adversary
ray exec ../autoscale.yaml "python /home/ubuntu/adversarial_sim2real/run_scripts/linear_env/run_linear_env.py \
--num_iters 300 --train_batch_size 30000 --num_cpus 8 --advs_per_strength 5 \
--num_adv_strengths 1 --advs_per_rew 5 --num_adv_rews 1 --exp_title linear_RARL_5adv_d10_conc100_h200_smallbatch --run_transfer_tests \
--grid_search --use_s3 --dim 10 --multi_node --horizon 200 --scaling -0.8 --adv_strength 0.4 --agent_strength 1.1 --regret --adv_action_type eigs" \
--start --stop --tmux --cluster-name=ev_lin_test3
...
ray exec ../autoscale.yaml "python /home/ubuntu/adversarial_sim2real/run_scripts/linear_env/run_linear_env.py \
--num_iters 300 --train_batch_size 30000 --num_cpus 8 --advs_per_strength 10 \
--num_adv_strengths 1 --advs_per_rew 10 --num_adv_rews 1 --exp_title linear_RARL_10adv_d10_conc100_h200_smallbatch --run_transfer_tests \
--grid_search --use_s3 --dim 10 --multi_node --horizon 200 --scaling -0.8 --adv_strength 0.4 --agent_strength 1.1 --regret --adv_action_type eigs" \
--start --stop --tmux --cluster-name=ev_lin_test4
...
ray exec ../autoscale.yaml "python /home/ubuntu/adversarial_sim2real/run_scripts/linear_env/run_linear_env.py \
--num_iters 300 --train_batch_size 30000 --num_cpus 8 --advs_per_strength 20 \
--num_adv_strengths 1 --advs_per_rew 20 --num_adv_rews 1 --exp_title linear_RARL_30adv_d10_conc100_h200_smallbatch --run_transfer_tests \
--grid_search --use_s3 --dim 10 --multi_node --horizon 200 --scaling -0.8 --adv_strength 0.4 --agent_strength 1.1 --regret --adv_action_type eigs" \
--start --stop --tmux --cluster-name=ev_lin_test5
...
ray exec ../autoscale.yaml "python /home/ubuntu/adversarial_sim2real/run_scripts/linear_env/run_linear_env.py \
--num_iters 300 --train_batch_size 30000 --num_cpus 8 --advs_per_strength 5 \
--num_adv_strengths 1 --advs_per_rew 1 --num_adv_rews 5 --exp_title linear_DAMLT_5adv_d10_h200_low10_smallbatch --run_transfer_tests \
--reward_range --low_reward -10 \
--grid_search --use_s3 --dim 10 --multi_node --horizon 200 --scaling -0.8 --adv_strength 0.4 --agent_strength 1.1 --regret --adv_action_type eigs" \
--start --stop --tmux --cluster-name=ev_lin_test6
...
ray exec ../autoscale.yaml "python /home/ubuntu/adversarial_sim2real/run_scripts/linear_env/run_linear_env.py \
--num_iters 300 --train_batch_size 30000 --num_cpus 8 --advs_per_strength 10 \
--num_adv_strengths 1 --advs_per_rew 1 --num_adv_rews 10 --exp_title linear_DAMLT_10adv_d10_h200_low10_smallbatch --run_transfer_tests \
--reward_range --low_reward -10 \
--grid_search --use_s3 --dim 10 --multi_node --horizon 200 --scaling -0.8 --adv_strength 0.4 --agent_strength 1.1 --regret --adv_action_type eigs" \
--start --stop --tmux --cluster-name=ev_lin_test7
...
ray exec ../autoscale.yaml "python /home/ubuntu/adversarial_sim2real/run_scripts/linear_env/run_linear_env.py \
--num_iters 300 --train_batch_size 30000 --num_cpus 8 --advs_per_strength 20 \
--num_adv_strengths 1 --advs_per_rew 1 --num_adv_rews 20 --exp_title linear_DAMLT_20adv_d10_h200_low10_smallbatch --run_transfer_tests \
--reward_range --low_reward -10 \
--grid_search --use_s3 --dim 10 --multi_node --horizon 200 --scaling -0.8 --adv_strength 0.4 --agent_strength 1.1 --regret --adv_action_type eigs" \
--start --stop --tmux --cluster-name=ev_lin_test8
...
ray exec ../autoscale.yaml "python /home/ubuntu/adversarial_sim2real/run_scripts/linear_env/run_linear_env.py \
--num_iters 300 --train_batch_size 30000 --num_cpus 8 --advs_per_strength 5 \
--num_adv_strengths 1 --advs_per_rew 1 --num_adv_rews 5 --exp_title linear_DAMLT_5adv_d10_h200_low100_smallbatch --run_transfer_tests \
--reward_range --low_reward -100 \
--grid_search --use_s3 --dim 10 --multi_node --horizon 200 --scaling -0.8 --adv_strength 0.4 --agent_strength 1.1 --regret --adv_action_type eigs" \
--start --stop --tmux --cluster-name=ev_lin_test9
...
ray exec ../autoscale.yaml "python /home/ubuntu/adversarial_sim2real/run_scripts/linear_env/run_linear_env.py \
--num_iters 300 --train_batch_size 30000 --num_cpus 8 --advs_per_strength 10 \
--num_adv_strengths 1 --advs_per_rew 1 --num_adv_rews 10 --exp_title linear_DAMLT_10adv_d10_h200_low100_smallbatch --run_transfer_tests \
--reward_range --low_reward -100 \
--grid_search --use_s3 --dim 10 --multi_node --horizon 200 --scaling -0.8 --adv_strength 0.4 --agent_strength 1.1 --regret --adv_action_type eigs" \
--start --stop --tmux --cluster-name=ev_lin_test10
...
ray exec ../autoscale.yaml "python /home/ubuntu/adversarial_sim2real/run_scripts/linear_env/run_linear_env.py \
--num_iters 300 --train_batch_size 30000 --num_cpus 8 --advs_per_strength 20 \
--num_adv_strengths 1 --advs_per_rew 1 --num_adv_rews 20 --exp_title linear_DAMLT_20adv_d10_h200_low100_smallbatch --run_transfer_tests \
--reward_range --low_reward -100 \
--grid_search --use_s3 --dim 10 --multi_node --horizon 200 --scaling -0.8 --adv_strength 0.4 --agent_strength 1.1 --regret --adv_action_type eigs" \
--start --stop --tmux --cluster-name=ev_lin_test11