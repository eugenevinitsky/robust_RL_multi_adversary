...
from algorithms.baselines_her.multiagent_her.cmd_util import make_env
...
from algorithms.baselines_her.run import build_env
...
save_path = "/Users/eugenevinitsky/her_results/models/05-23-2020/model_test2"
...
def main(args):
    ...
    results_dir = os.path.join(os.path.dirname(save_path), 'results')
    if not os.path.exists(results_dir):
        os.makedirs(results_dir)
    run_transfer_tests(results_dir, env, env_id, model, 1)
