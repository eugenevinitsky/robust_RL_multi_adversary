...
--train_batch_size 15000 --checkpoint_freq 50 --num_iters 400 --kl_diff_weight 0 --num_adv 1 --perturb_actions --num_cpus 3 --run_transfer_tests --human_num 4" \
--tmux --start --cluster-name=ma_test1
...
--train_batch_size 15000 --checkpoint_freq 50 --num_iters 400 --kl_diff_weight 0 --num_adv 3 --perturb_actions --num_cpus 3 --run_transfer_tests --human_num 4" \
--tmux --start --cluster-name=ma_test2
...
--train_batch_size 15000 --checkpoint_freq 50 --num_iters 400 --kl_diff_weight 0 --num_adv 1 --perturb_state --num_cpus 3 --run_transfer_tests --human_num 4" \
--tmux --start --cluster-name=ma_test3
...
--train_batch_size 15000 --checkpoint_freq 50 --num_iters 400 --kl_diff_weight 0 --num_adv 3 --perturb_state --num_cpus 3 --run_transfer_tests --human_num 4" \
--tmux --start --cluster-name=ma_test4
