...
--exp_title hop_5adv_2ps_str5p0_concat20_curr --num_cpus 3 --run_transfer_tests --goal_score 3000 --multi_node" \
...
--exp_title hop_5adv_2ps_str10p0_concat20_curr --num_cpus 3 --run_transfer_tests --goal_score 3000 --multi_node" \
...
--num_adv_strengths 5 --advs_per_strength 2 --adv_strength 5.0 --grid_search --use_s3 --env_name hopper \
--exp_title hop_5adv_2ps_str5p0_concat1_curr --num_cpus 3 --run_transfer_tests --goal_score 3000 --multi_node" \
...
--train_batch_size 10000 --num_iters 1000 --checkpoint_freq 100 --curriculum --num_concat_states 1 \
--num_adv_strengths 5 --advs_per_strength 2 --adv_strength 10.0 --grid_search --use_s3 --env_name hopper \
--exp_title hop_5adv_2ps_str10p0_concat1_curr --num_cpus 3 --run_transfer_tests --goal_score 3000 --multi_node" \
...
--exp_title hop_1adv_1ps_str10p0_concat1_curr --num_cpus 3 --run_transfer_tests --goal_score 3000 --multi_node" \
...
--train_batch_size 10000 --num_iters 1000 --checkpoint_freq 100 --curriculum --concat_actions --num_concat_states 20 \
--num_adv_strengths 1 --advs_per_strength 1 --adv_strength 10.0 --grid_search --use_s3 --env_name hopper \
--exp_title hop_1adv_1ps_str10p0_concat20_curr --num_cpus 3 --run_transfer_tests --goal_score 3000 --multi_node" \
...
--exp_title hop_0adv_0ps_str10p0_concat1_curr --num_cpus 3 --run_transfer_tests --multi_node" \
...
--train_batch_size 10000 --num_iters 1000 --checkpoint_freq 100 --curriculum --concat_actions --num_concat_states 20 \
--num_adv_strengths 5 --advs_per_strength 2 --adv_strength 5.0 --grid_search --use_s3 --env_name hopper \
--exp_title hop_5adv_2ps_str5p0_concat20_curr_gs2500 --num_cpus 3 --run_transfer_tests --goal_score 2500 --multi_node" \
...
--num_adv_strengths 5 --advs_per_strength 2 --adv_strength 5.0 --grid_search --use_s3 --env_name hopper \
--exp_title hop_5adv_2ps_str5p0_concat1_curr_gs2500 --num_cpus 3 --run_transfer_tests --goal_score 2500 --multi_node" \
