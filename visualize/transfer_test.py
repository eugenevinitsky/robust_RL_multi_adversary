...
def run_transfer_tests(rllib_config, checkpoint, num_rollouts, output_file_name, show_images=False, outdir='transfer_results'):
    file_path = os.path.dirname(os.path.abspath(__file__))

    # First compute a baseline score to compare against
    base_rewards = run_rollout(rllib_config, checkpoint, save_trajectory=True, video_file="base",
    ...
    friction_rewards = run_rollout(temp_config, checkpoint, save_trajectory=True, video_file="friction",
                                   show_images=show_images, num_rollouts=num_rollouts)
    ...
    color_rewards = run_rollout(temp_config, checkpoint, save_trajectory=True, video_file="colours",
                                show_images=show_images,  num_rollouts=num_rollouts)
    ...
    unrestrict_goal_reg_rewards = run_rollout(temp_config, checkpoint, save_trajectory=True, video_file="goal_reg",
                                              show_images=show_images, num_rollouts=num_rollouts)
    ...
    chase_robot_rewards = run_rollout(temp_config, checkpoint, save_trajectory=True, video_file="chase_rob",
                                      show_images=show_images, num_rollouts=num_rollouts)
    ...
    gaussian_state_rewards = run_rollout(temp_config, checkpoint, save_trajectory=False, video_file="gauss_state",
                                         show_images=show_images, num_rollouts=num_rollouts)
    ...
    gaussian_action_rewards = run_rollout(temp_config, checkpoint, save_trajectory=False, video_file="gauss_ac",
                                          show_images=show_images, num_rollouts=num_rollouts)
    ...
    temp_config['env_config']['add_gaussian_noise_action'] = True
    temp_config['env_config']['add_gaussian_noise_action'] = True
    gaussian_state_action_rewards = run_rollout(temp_config, checkpoint, save_trajectory=False, video_file="gauss_both",
                                                show_images=show_images, num_rollouts=num_rollouts)
...
if __name__ == '__main__':
    ...
    run_transfer_tests(rllib_config, checkpoint, args.num_rollouts, args.output_file_name, show_images=False)