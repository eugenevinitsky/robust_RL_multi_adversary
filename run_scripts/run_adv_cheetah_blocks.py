...
from envs.ma_hc_blocks import MAHalfCheetahBlocks
...
def setup_exps(args, parser=None):
    ...
    env_name = "MAHalfCheetahBlocks"
    create_env_fn = make_create_env(MAHalfCheetahBlocks)
...
if __name__ == "__main__":
    ...
    if args.run_transfer_tests:
        output_path = os.path.join(os.path.join(os.path.expanduser('~/transfer_results/MA_HC_Blocks'), date),
                                   args.exp_title)
