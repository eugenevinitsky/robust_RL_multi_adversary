...
--exp_title lunar_RARL_10adv_concat1_grid --num_cpus 9 --run_transfer_tests --multi_node \
...
--num_iters 1000 --train_batch_size 10000 --checkpoint_freq 100 --num_concat_states 1 \
--num_adv_strengths 1 --advs_per_strength 10 --advs_per_rew 1 --num_adv_rews 10 --grid_search --use_s3 \
--exp_title lunar_DMALT_10adv_concat1_grid --num_cpus 9 --run_transfer_tests --multi_node \
...
--exp_title lunar_dr_concat1_grid --num_cpus 1 --run_transfer_tests --multi_node --domain_randomization" \
