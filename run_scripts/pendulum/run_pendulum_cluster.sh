...
--checkpoint_freq 20 --num_iters 300 --num_cpus 4 --num_adv 0 --model_based --adv_strength 0.0 --run_transfer_tests\
 --grid_search --use_s3" --start --stop --tmux --cluster-name=ev_pend_test5