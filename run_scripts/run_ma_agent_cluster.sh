...
--train_batch_size 15000 --checkpoint_freq 50 --num_iters 4000 --kl_diff_weight 0 --num_adv 5 --perturb_actions --num_cpus 8 --run_transfer_tests --human_num 0 --grid_search --algorithm DDPG" \
--tmux --start --stop --cluster-name=ev_ma_test5
...
--train_batch_size 15000 --checkpoint_freq 50 --num_iters 4000 --kl_diff_weight 0 --num_adv 10 --perturb_actions --num_cpus 8 --run_transfer_tests --human_num 0 --grid_search --algorithm DDPG" \
--tmux --start --stop --cluster-name=ev_ma_test6