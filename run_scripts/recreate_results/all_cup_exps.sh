...
--seed_search --lambda_val 0.9 --lr .00005" --start --stop --tmux --cluster-name=yd_cup_test1
...
--seed_search --lambda_val 0.9 --lr .00005" --start --stop --tmux --cluster-name=yd_cup_test2
...
--seed_search --lambda_val 0.9 --lr .00005" --start --stop --tmux --cluster-name=yd_cup_test6
...
--seed_search --lambda_val 0.9 --lr .000005" --start --stop --tmux --cluster-name=yd_cup_test3
...
--concat_actions --seed_search --lambda_val 0.9 --lr .00005" --start --stop --tmux --cluster-name=yd_cup_test9
