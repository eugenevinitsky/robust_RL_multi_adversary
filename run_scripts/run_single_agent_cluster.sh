...
ray exec ../autoscale.yaml "python /home/ubuntu/adversarial_sim2real/run_scripts/test_rllib_script.py --exp_title SA_h4 --use_s3 \
--train_batch_size 30000 --checkpoint_freq 50 --num_iters 300 --num_cpus 18 --run_transfer_tests --human_num 4" --tmux --start --cluster-name=ev_sa_test1

ray exec ../autoscale.yaml "python /home/ubuntu/adversarial_sim2real/run_scripts/test_rllib_script.py --exp_title SA_GaS_h4 --use_s3 \
--train_batch_size 30000 --checkpoint_freq 50 --num_iters 300 --add_gaussian_noise_state --num_cpus 18 --run_transfer_tests --human_num 4" \
...
--train_batch_size 30000 --checkpoint_freq 50 --num_iters 300 --num_cpus 18 --run_transfer_tests --human_num 1" --tmux --start --cluster-name=ev_sa_test3

ray exec ../autoscale.yaml "python /home/ubuntu/adversarial_sim2real/run_scripts/test_rllib_script.py --exp_title SA_GaS_h1 --use_s3 \
--train_batch_size 30000 --checkpoint_freq 50 --num_iters 300 --add_gaussian_noise_state --num_cpus 18 --run_transfer_tests --human_num 1" \
