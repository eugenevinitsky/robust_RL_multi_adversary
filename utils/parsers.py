...
def ray_parser(parser):
    ...
    parser.add_argument('--train_batch_size', type=int, default=30000, help='How many steps go into a training batch')
    ...
    parser.add_argument('--local_mode', action='store_true', help='If true, Ray is in local mode')
...
def ma_env_parser(parser):
    ...
    parser.add_argument("--kl_diff_clip", type=float, default=10.0,
                        help="KL values are clipped to be between this number and zero")
    return parser
